...
urlpatterns = [
    ...
    path('adminupdatestatuspage/',views.adminupdatestatuspage,name='adminupdatestatuspage'),
    path('admin_get_update_status/',views.admin_get_update_status,name='admin_get_update_status'),
    path('adminupdatestatus/',views.adminupdatestatus,name='adminupdatestatus'),
    ...
    path('downloaddepartmentreport/',views.downloaddepartmentreport,name='downloaddepartmentreport'),
